# module ups_sythn is borrow from https://github.com/guanyingc/SDPS-Net
# It is for reading the dataset used in SDPS-Net: PS Blobby and Sculpture datasets
import importlib
import torch.utils.data

def find_dataset_from_string(dataset_name):
    datasetlib = importlib.import_module('ups_sythn.%s' % dataset_name)
